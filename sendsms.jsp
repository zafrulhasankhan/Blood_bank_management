<%-- 
    Document   : test
    Created on : March 2, 2020, 12:40:59 AM
    Author     : Piya
--%>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name">
                                    Message</label>
                                <textarea autofocus class="form-control textarea" rows="2" name="message" id="message" placeholder="your message here">Urgent <%=request.getParameter("bloodgroup")%> needed, Name: <%=request.getParameter("firstname")%> <%=request.getParameter("lastname")%>, mobile: <%=request.getParameter("phone")%></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
