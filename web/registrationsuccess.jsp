<%-- 
    ...
    Created on : Feb 12, 2020, 10:19:33 PM
        ...
        <div class="container">
            <div class="row text-center" style="float: center" align="center">
                <div class="col col-sm-offset-4">
                    ...
                    <p style="font-size:20px;color:#5C5C5C;">Thank you for registering into our web site. Please update your profile with your details.
