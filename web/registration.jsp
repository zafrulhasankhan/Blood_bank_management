                ...
                <div class="col-md-9 register-right">
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <form action="RegistrationController" method="post">
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" minlength="11" name="phone" class="form-control" placeholder="Your Phone *" required/>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" name="bldgrp" required>
                                                <option class="hidden" value="" selected disabled>Please select your Blood Group</option>
                        ...
                        <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <h3  class="register-heading">Apply as Blood Bank</h3>
                            <form action="BBRegistrationController" method="post">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Blood Bank Name *" name="bldbank" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control" placeholder="Email *" name="email" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" minlength="11" class="form-control" placeholder="Phone *" name="phone" required/>
                                        </div>
